...
/// <ul>
///   <li>
///     <a href="x-source-tag://sdkKey">Fidel.sdkKey</a> - Set your SDK key.
///   </li>
///   <li>
...
///   </li>
///   <li>
///     <a href="x-source-tag://FidelAppDelegate">FidelAppDelegate</a>
///   </li>
/// </ul>
/// version:
/// 1.8.6
...
/// since:
/// 1.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nullable sdkKey;)
+ (NSString * _Nullable)sdkKey SWIFT_WARN_UNUSED_RESULT;
+ (void)setSdkKey:(NSString * _Nullable)value;
...
///   </li>
///   <li>
///     <a href="x-source-tag://programType">Fidel.programType</a> - Set your program type.
///   </li>
/// </ul>
/// since:
/// 1.0
...
/// Specifies the type of program you want to link cards into.
/// <h2>See also:</h2>
/// <ul>
///   <li>
///     <a href="x-source-tag://programId">Fidel.programId</a> - Set your SDK key.
///   </li>
///   <li>
///     <a href="x-source-tag://Fidel.ProgramType">Fidel.ProgramType</a> - Existing program types enum you can choose from.
///   </li>
/// </ul>
/// note:
///
/// The default value is <code>.transactionSelect</code>.
/// since:
/// 1.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum FLProgramType programType;)
+ (enum FLProgramType)programType SWIFT_WARN_UNUSED_RESULT;
+ (void)setProgramType:(enum FLProgramType)value;
...
SWIFT_PROTOCOL_NAMED("FidelHostApplication")
@protocol FLFidelHostApplication
...
/// The country code of the linked card. Possible values: <code>"GBR"</code> (Great Britain),
/// <code>"IRL"</code> (Ireland), <code>"USA"</code> (United States of America),
/// <code>"SWE"</code> (Sweden), <code>"JPN"</code> (Japan), <code>"CAN"</code> (Canada).
/// since:
/// 1.0.2
...
/// Enum with available Fidel program types.
/// <h2>See also:</h2>
/// <ul>
///   <li>
///     <a href="x-source-tag://programType">Fidel.programType</a>.
///   </li>
/// </ul>
/// since:
/// 2.0
typedef SWIFT_ENUM_NAMED(NSInteger, FLProgramType, "ProgramType", open) {
/// Captures transactions made at participating merchants that the cardholder has opted in to/selected. Transaction will always be matched to locations.
/// since:
/// 2.0
  FLProgramTypeTransactionSelect = 0,
/// Enables you to act on real time transaction data for all transactions made on an enrolled card, regardless of the merchant. Transaction will not be matched to locations.
/// since:
/// 2.0
  FLProgramTypeTransactionStream = 1,
};


@interface UIApplication (SWIFT_EXTENSION(Fidel)) <FLFidelHostApplication>
@end
