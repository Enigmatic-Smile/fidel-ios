...
/// Use this facade class to initialise and start a Fidel card connection experience.
...
///   </li>
///   <li>
///     <a href="x-source-tag://start">Fidel.start function</a> - Starts the flow for connecting a card with your Fidel program.
///   </li>
/// </ul>
/// since:
/// 1.0
SWIFT_CLASS("_TtC5Fidel5Fidel")
@interface Fidel : NSObject
